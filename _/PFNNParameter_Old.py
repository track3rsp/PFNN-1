...
class PFNNParameter:
    ...
    def setIndexAmount(self, phase):
        ...
        self.pindex_1 = pindex_1
        self.bamount = bamount
        self.wamount = wamount
        self.pindex_0 = (pindex_1-1) % nslices
        self.pindex_2 = (pindex_1+1) % nslices
        self.pindex_3 = (pindex_1+2) % nslices
    
    
    def setWeightBias(self,phase):
        self.setIndexAmount(phase)
