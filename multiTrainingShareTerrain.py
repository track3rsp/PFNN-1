...
def LoadDog(filename):
    ...
    return input_x, input_y, input_size, output_size, number_example, index_terrain
    

input_human, output_human, inputSize_human, outputSize_human, size_human               = LoadHuman('database.npz')
input_dog,   output_dog,   inputSize_dog,   outputSize_dog,   size_dog,  index_terrain = LoadDog('Data.txt')
...
P0_human  = PFNNParameter((nslices, 512, inputSize_human-1 - terrainNuerons), rng, phase, 'wb0_human')
...
W0_terrain = P0_dog.getWeights(index_terrain)


"""weights and parameter of nn"""
W0 = tf.cond(tf.less(tensor_1, flag), 
             lambda: tf.concat([P0_human.weight, W0_terrain], axis = -1),
